...
namespace AspNet.Identity.SQLite
{
        ...
        where TUser :IdentityUser
    {
        ...
        {
            string commandText = @"Insert into Users (UserName, Id, PasswordHash, Email,EmailConfirmed)
                values (@name, @id, @pwdHash, @email,@emailconfirmed)";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
        ...
        {
            string commandText = @"Update Users set UserName = @userName, PasswordHash = @pswHash, 
