...
namespace UserControls
{
    public partial class UCBaseParameters : UserControl, IReportParameters
    {
        ...
        private string[] _ParamNames = { "ChartColor", "Is3D", "IsHorizontal", "IsShowLbs", "IsLeanPathLogo", "Title", "SubTitle", "IsCustomLogo", "Filter", "IsShowReport", "ReportID", "SiteID", "WasteClasses", "IsPercent", "IsToggleFooter" };
        private string[] _DefaultValues = { "Iceberg", "False", "False", "False", "True", "", "", "False", "", "True", "-1", "0", "", "False", "False", "False" };
        private string[] _ParamTypes = { "ChartColor", "Boolean", "Boolean", "Boolean", "Boolean", "String", "String", "Boolean", "String", "Boolean", "Number", "Number", "All", "Boolean", "Boolean", "Boolean" };
        ...
        private void DisplayHashValues()
        {
            ...
            chkToggleFooter.Checked = bool.Parse(((ReportParameter)_ParamTable["IsToggleFooter"]).ParamValue.ToString());
        ...
        public string GetValue(string name)
        {
            switch (name)
            {
                ...
                case "IsToggleFooter":
                    return chkToggleFooter.Checked.ToString();
                case "Title":
                ...
                case "SiteID":
                    return ((ReportParameter)_ParamTable["SiteID"]).ParamValue;
                case "WasteClasses":
        ...
        public ReportParameter GetItem(string name)
        {
            switch (name)
            {
                ...
                case "IsToggleFooter":
                    return new ReportParameter(name, chkToggleFooter.Checked.ToString(), chkToggleFooter.Checked.ToString(), "Boolean");
                case "Title":
