...
namespace UserControls
{
    public partial class UCComparisionParameters : UserControl, IReportParameters
    {
        ...
        {
            dtStartWeek.Value = DateTime.Parse(((ReportParameter)_ParamTable["FirstWeekStart"]).ParamValue, CultureInfo.GetCultureInfo("en-US"), System.Globalization.DateTimeStyles.None);
            dtCompareWeek.Value = DateTime.Parse(((ReportParameter)_ParamTable["SecondWeekStart"]).ParamValue, CultureInfo.GetCultureInfo("en-US"), System.Globalization.DateTimeStyles.None);
