...
namespace Reports
{
    ...
    /// </summary>
    public partial class rptTop10Stations : DataDynamics.ActiveReports.ActiveReport
    {
        private UserControls.ARParameters _InputParameters;
        public rptTop10Stations(UserControls.ARParameters InputParameters)
        {
            //
        ...
        private int _iRow;
        private void rptTop10Stations_ReportStart(object sender, EventArgs e)
        {
            this._iRow = 0;
            if (_InputParameters.ParamName == "Station")
                this.Cancel();
            else
            {
