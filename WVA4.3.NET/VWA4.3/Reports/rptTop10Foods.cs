...
namespace Reports
{
    ...
    /// </summary>
    public partial class rptTop10Foods : DataDynamics.ActiveReports.ActiveReport
    {
        private UserControls.ARParameters _InputParameters;
        public rptTop10Foods(UserControls.ARParameters InputParameters)
        {
            //
        ...
        private int _iRow;
        private void rptTop10Foods_ReportStart(object sender, EventArgs e)
        {
            this._iRow = 0;
            if (_InputParameters.ParamName == "Food")
                this.Cancel();
            else {
