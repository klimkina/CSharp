...
namespace UserControls
{
	public partial class UCGoalListbyCompletionParameters : UserControl, IReportParameters
	{
		...
		public string GetValue(string name)
		{
			...
			{
				case "ReportDate":
					return dtReportDate.Value.ToString("MM/dd/yyyy", CultureInfo.GetCultureInfo("en-US"));
				case "ReportMode":
		...
		public ReportParameter GetItem(string name)
		{
			...
			{
				case "ReportDate":
					return new ReportParameter(name, dtReportDate.Value.ToString("MM/dd/yyyy", CultureInfo.GetCultureInfo("en-US")), dtReportDate.Value.ToString("MM/dd/yyyy", CultureInfo.GetCultureInfo("en-US")), "DateTime");
				case "ReportMode":
