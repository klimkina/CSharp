...
namespace UserControls
{
    public partial class UCLowParticipationParameters : UserControl
    {
		...
		public void InitRunTime()
		{
            ...
            ucComparisonSiteDetailsParameters1.InitDefault();
        ...
        public void SetComparision()
        {
            ...
            ucTreeFilter1.Visible = true;
            ucTreeFilter1.Title = "Additional Filters: ";
            ucTreeFilter1.EnableAllSites(true);

            ucTreeFilter1.EnableAllRadioButtons();
        }

        public void SetComparisionSiteDetails()
        {
            HideAllParameters();
            _ReportType = "Comparison: Site Details";
            ucComparisonSiteDetailsParameters1.Active = true;
            ucComparisonSiteDetailsParameters1.Visible = true;
            //ucComparisonSiteDetailsParameters1.BringToFront();
            ...
            ucDateRangePeriodParameters1.BringToFront();
        ...
        public void SetTabular()
        {
            HideAllParameters();
            _ReportType = "Tabular";


            ucTabularParameters1.Active = true;
            ucTabularParameters1.Visible = true;
        ...
        private void HideAllParameters()
        {
            ...
            ucComparisonSiteDetailsParameters1.Active = false;
            ucComparisonSiteDetailsParameters1.Visible = false;
            ...
            ucTreeFilter1.Visible = false;
            ucTreeFilter1.Clear();
            if (ucTreeFilter1.IsAllSites)
            {
                ucTreeFilter1.EnableAllSites(false);
                ucTreeFilter1.EnableSiteChooser();
            }

            ucTrendParameters1.Active = false;
            ucTrendParameters1.Visible = false;

            ucWasteAvoidanceParameters1.Active = false;
            ucWasteAvoidanceParameters1.Visible = false;
        ...
        public ReportParameters ReportParameters
        {
            get
            {
                ...
                if (isPeriodSet)
                {
                    startDate = DateTime.Parse(param["StartDate"].ParamValue, CultureInfo.GetCultureInfo("en-US"), System.Globalization.DateTimeStyles.None);
                    endDate = DateTime.Parse(param["EndDate"].ParamValue, CultureInfo.GetCultureInfo("en-US"), System.Globalization.DateTimeStyles.None);
        ...
        public void LoadParameters(int id, bool isCorrectWeekly)
        {
            try
            {
                ...
                if (parameter["SiteID"] != null && parameter["SiteID"].ParamValue == "-1")
                {
                    ucTreeFilter1.SetAllSites();
        ...
        private void ucComparisonSiteDetailsParameters1_ComparisionTypeChanged(object sender, UCComparisonSiteDetailsParameters.ComparisionTypeChangedEventArgs e)
        {
            ucTreeFilter1.DisableRadioButtonByName(e.ComparisionType);
        }
