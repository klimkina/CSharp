...
namespace UserControls
{
    public partial class UCDashBoard : UserControl, IVWAUserControlBase
    {
		...
		public void LoadData()
        {
			...
			//    + (DateTime.Parse(VWA4Common.GlobalSettings.StartDateOfSelectedWeek).AddDays(7)).ToString("yyyy/MM/dd")
			//    + " 00:00:00#))";
            ...
            sql = "SELECT SUM(FoodCostActual) AS foodcost_priormo, SUM(FoodRevenueActual) AS foodrevenue_priormo,"
				...
				+ priormonthstart.ToString("yyyy/MM/dd") + "#) AND (fin.PeriodStartDate < #"
