...
namespace Reports
{
    ...
    public partial class rptSWATNotes : DataDynamics.ActiveReports.ActiveReport
    {
        ...
        private void rptSWATNotes_ReportStart(object sender, EventArgs e)
        {
            ...
            string swatDate = DateTime.Parse(_InputParameters["SWATDate"].ParamValue).ToString("yyyy/MM/dd");
            ...
            if(dt.Rows.Count > 0)
                txtPeriods.Text = DateTime.Parse(dt.Rows[0][0].ToString()).ToString("MM/dd/yyyy") + " - " +
                    DateTime.Parse(dt.Rows[0][0].ToString()).AddDays(6).ToString("MM/dd/yyyy");
            else
                txtPeriods.Text = DateTime.Parse(_InputParameters["SWATDate"].ParamValue).ToString("MM/dd/yyyy") + " - " +
                    DateTime.Parse(_InputParameters["SWATDate"].ParamValue).AddDays(6).ToString("MM/dd/yyyy");
