...
namespace CSUWPDuplex.CalculatorService
{
    ...
    {
        [System.ServiceModel.OperationContractAttribute(IsOneWay = true, Action = "http://tempuri.org/ICalculator/RegisterClient")]
    ...
    public class BroadcastToClientReceivedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {

        private object[] results;

        public BroadcastToClientReceivedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) :
                base(exception, cancelled, userState)
        {
            this.results = results;
        }
    ...
    public partial class CalculatorClient : CalculatorClientBase
    {
        ...
        public event System.EventHandler<BroadcastToClientReceivedEventArgs> BroadcastToClientReceived;

        private void OnBroadcastToClientReceived(object state)
        {
            if ((this.BroadcastToClientReceived != null))
            {
                object[] results = ((object[])(state));
                this.BroadcastToClientReceived(this, new BroadcastToClientReceivedEventArgs(results, null, false, null));
            }
        }
        ...
        private class CalculatorClientCallback : object, ICalculatorCallback
        {
            ...
            {
                this.proxy.OnBroadcastToClientReceived(new object[] {
                            message});
            }
        }
    }
